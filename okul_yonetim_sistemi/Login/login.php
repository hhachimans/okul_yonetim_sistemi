    ...
    <body class="login-background">
        ...
        <div class="login-div mt-3 rounded">
            ...
            <div class="login-padding">
                <h2 class="text-center text-white">GİRİŞ</h2>
                <form class="p-1" action="login.php" method="POST">
                    <div class="form-group">
                        <label><h6>ID veya Mail:</h6></label>
                        <input type="text" name="email" placeholder="Mail" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label><h6>Şifre:</h6></label>
                        <input type="Password" name="password" placeholder="Şifre" class="form-control border-bottom" >
                        <!-- <?php echo $message; ?> -->
                    </div>
                    <div class="form-group text-center mb-3 mt-4">
                        <input type="submit" name="btnlogin" value="Giriş Yap" class="btn btn-white pl-5 pr-5 ">
                    </div>
                </form>
            </div>
        </div>
