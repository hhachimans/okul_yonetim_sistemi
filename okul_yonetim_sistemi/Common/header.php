...
<nav class="navbar navbar-expand-lg navbar-dark header-back sticky-top header-navbar-fonts">
	...
	<a class="navbar-brand d-flex align-items-center" href="index.php">
		...
		<h3 class="text-light text-uppercase ml-2">Karadeniz Teknik Üniversitesi</h3>
	</a>
	...
	<div class="collapse navbar-collapse" id="navbarNavDropdown">
		<ul class="navbar-nav ml-auto">
			...
			<li class="nav-item active">
				<a class="nav-link" href="academics.php">Akademi<span class="sr-only">(current)</span></a>
			</li>
			<li class="nav-item active">
