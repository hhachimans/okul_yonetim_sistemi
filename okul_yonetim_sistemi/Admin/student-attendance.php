		...
		<main role="main" class="col-xl-10 col-lg-9 col-md-8 ml-sm-auto px-md-4 mb-2 w-100">
			<div class="sub-main">
				<div class="bar-margin text-center d-flex flex-wrap flex-md-nowrap pt-3 pb-2 mb-3 text-white admin-dashboard pl-3">
					<h4>Öğrenci Ders Katılımı Yönetim Sistemi </h4>
				</div>
				<div class="row w-100">
					<div class="col-md-12">
						<form action="student-attendance.php" method="post">
							<div class="row mt-3">
								...
								<div class="col-md-4">
									...
									<label for="exampleInputEmail1">Dönem Seç:</label>
								...
								<div class="col-md-6">
									<input type="submit" name="submit" class="btn btn-primary px-5" value="İşle">
								</div>
							</div>	
						</form>
					</div>
							...
							<table class="w-100 table-elements table-three-tr" cellpadding="3">
								...
								$count=0;
									...
									?>
										...
										<?php 	}
											?>
											<td>Mevcut<input type="checkbox" name="attendance[]" value="1">Mevcut Değil<input type="checkbox" name="attendance[]" value="0" ></td>
