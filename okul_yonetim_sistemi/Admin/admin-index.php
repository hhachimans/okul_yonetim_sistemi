...
<title>Admin - ICBS</title>
   ...
   <?php include('common/admin-sidebar.php'); ?>
      <main role="main" class="col-xl-10 col-lg-9 col-md-8 ml-ms-auto px-md-4 mb-2 w-100 page-content-index">
      	...
      	<div class="row">
      		<div class="col-lg-6 col-md-12 col-sm-12">
      			<div>
      				<section class="mt-3">
      					<div class="btn btn-block table-one text-ligth d-flex">
      						<span class="font-weight-bold"><i class="fa fa-clock-o mr-2" aria-hidden="true">Time Table</i></span>
      						<a href="" class="ml-auto" data-toggle="collapse" data-target="#collapseOne"><i class="fa fa-plus text-ligth"aria-hidden="true"></i></a>
      					</div>
      		...
      		<div class="col-lg-6 col-md-12 col-sm-12">
      			<div>
      				<section class="mt-3">
      					<div class="btn btn-clock table-two text-ligth d-flex">
      						<span class="font-weight-bold"><i class="fa fa-list-alt mr-2" aria-hidden="true">Program List</i></span>
      						<a href="" class="ml-auto" data-toggle="collapse" data-target="#collapseOne"><i class="fa fa-plus text-ligth" aria-hidden="true"></i></a>
      					</div>
      		...
      		<div class="col-md-12">
      			<div>
      				<section class="mt-4">
      					<div class="btn btn-block table-three text-ligth d-flex">
      						<span class="font-weight-bold"><i class="fa fa-asteriks mr-2" aria-hidden="true"></i>Deparment Subject Detail</span>
      						<a href="" class="ml-auto" data-toggle="collapse" data-target="collapsethree"><i class="fa fa-plus text-ligth" aria-hidden="true"></i></a>
      					</div>
